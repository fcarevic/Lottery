...
public class Constants {
	...
	public static final int SERVER_PORT_SUBSERVER=4001;
	public static final int SUBSERVER_PORT_TRAFFIC=4002;
	public static final int SUBSERVER_PORT_MAIN_SERVER = 4003;
